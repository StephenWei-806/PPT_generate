...
import json
import re
from flask import Response, stream_with_context, Blueprint, current_app, send_file
...
def generate_ppt_response(input_content, page_count, model, api_key):
    ...
    def generate_response():
        ...
        # 调用LLM服务生成内容
        for chunk in call_llm_api(prompt, page_count, model=model):
